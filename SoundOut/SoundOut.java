...
public class SoundOut implements ActionListener {
    ...
    private JFrame mainFrame = new JFrame("SoundOut");
    ...
    public final PlayerRef thisPlayer = new PlayerRef() {
        public Object getLock() {
            return statLock;
        }
    ...
    extends SwingWorker<Void, Void> {
        ...
        public Void doInBackground() {
            try {
    			...
    			if (!AudioSystem.isLineSupported(info))System.out.println("[-] line not supported nd stuff");
                ...
                try {
                    try {
                        final AudioFormat audioFormat = format;
                        ...
                        play_loop: do {
                            while(playerRef.getStat() == PlayStat.PLAYING) {
                               ...
                               playerRef.drawDisplay(samples, bread / normalBytes);
                                ...
                                /*
                                 * I REMOVED THE LINE ABOVE BECAUSE PLAYING BACK THE AUDIO CAUSES THE RESPONSE TO BE VERY SLOW
                                 * 
                                 */
                            }
